...
public class DataSuccessController {
    ...
    private final JulySiegeActivity mActivity;

    public DataSuccessController(LayoutSuccessOrderAnalyzeBinding binding, JulySiegeActivity activity) {
        mBinding = binding;
        mActivity = activity;
    ...
    public void refresh(ConditionFilter condition) {
        ...
        OkGo.<NetDataSuccess>post(HttpURLs.screen2Data1)
                .upJson(jo.toString())
