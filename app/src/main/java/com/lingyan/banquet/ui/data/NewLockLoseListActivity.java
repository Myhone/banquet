...
public class NewLockLoseListActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener, OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public static void start(String json, int type) {
        Intent intent = new Intent(App.sApp, NewLockLoseListActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new NewLockLoseAdapter(mRecData);
    ...
    private void requestNet(int page) {
        ...
        jo.addProperty("type", mType);
        OkGo.<NetLockLoseData>post(HttpURLs.screenLostList)
                .upJson(jo.toString())
                .execute(new JsonCallback<NetLockLoseData>() {
                    @Override
    ...
    public void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
        NetLockLoseData.DataDTO.ListDTO dto = mRecData.get(i);
