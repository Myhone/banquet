...
public class JulyDataFilterActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mGroupViewUtils.add("time_type", mBinding.tvFirstDay, "period0", false);
        mGroupViewUtils.add("time_type", mBinding.tvStageOne, "period1", false);
        mGroupViewUtils.add("time_type", mBinding.tvStageTwo, "period2", false);
        mGroupViewUtils.add("time_type", mBinding.tvStageThree, "period3", false);
        ...
        mBinding.tvFirstDay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean select = mGroupViewUtils.select("time_type", "period0");
                mBinding.llTimePickerContainer.setVisibility(View.GONE);
                if (select) {
                    mConditionFilter.time_type = "period0";
                } else {
                    mConditionFilter.time_type = null;
                }
        ...
        mBinding.tvStageOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean select = mGroupViewUtils.select("time_type", "period1");
                mBinding.llTimePickerContainer.setVisibility(View.GONE);
                if (select) {
                    mConditionFilter.time_type = "period1";
                } else {
                    mConditionFilter.time_type = null;
                }
        ...
        mBinding.tvStageTwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean select = mGroupViewUtils.select("time_type", "period2");
                mBinding.llTimePickerContainer.setVisibility(View.GONE);
                if (select) {
                    mConditionFilter.time_type = "period2";
                } else {
                    mConditionFilter.time_type = null;
                }
        ...
        mBinding.tvStageThree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean select = mGroupViewUtils.select("time_type", "period3");
                mBinding.llTimePickerContainer.setVisibility(View.GONE);
                if (select) {
                    mConditionFilter.time_type = "period3";
                } else {
                    mConditionFilter.time_type = null;
                }
