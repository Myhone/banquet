...
public class PrivacyDialog extends Dialog {
    ...
    private String contentDef = "宴帮帮根据法律法规及监管要求，制定了《用户服务条款》和《隐私政策》，特向你说明如下：\n" +
            "\n" +
            "1、为向您提供相关基本功能，我们会收集、使用必要的信息，你可以通过《隐私政策》了解我们会收集你个人信息的类型，了解我们如何收集、使用、存储你的个人信息，以及你拥有哪些权利等事宜。\n" +
            "\n" +
            "2、未经你的同意，我们不会向第三方主动提供、分享你的信息。\n" +
            "\n" +
            "3、若你同意，请点击“同意”确认，宴帮帮将严格按照《用户服务条款》和《隐私政策》向你提供服务；若不同意你可能无法使用宴帮帮提供的服务和产品。请仔细阅读并确保充分理解相关条款。\n" +
            "\n" +
            "请您仔细阅读《用户服务条款》和《隐私政策》，继续使用本应用即表明您同意接受此用户服务条款与隐私政策，我们会依法保护您的个人信息。\n";
